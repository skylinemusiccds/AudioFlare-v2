...
class DataStoreManager
    ...
    constructor(private val settingsDataStore: DataStore<Preferences>) {
        ...
        val musixmatchLoggedIn =
            settingsDataStore.data.map { preferences ->
                preferences[MUSIXMATCH_LOGGED_IN] ?: TRUE
            }
        ...
        val musixmatchCookie =
            settingsDataStore.data.map { preferences ->
                preferences[MUSIXMATCH_COOKIE] ?: "240318e406ba4520ed9b9cca83532810971ccfa9c9ba1c37932517"
            }
        ...
        val spotifyPersonalToken: Flow<String> =
            settingsDataStore.data.map { preferences ->
                preferences[SPOTIFY_PERSONAL_TOKEN] ?: "AQBt2i45jBLinx6Y_B-evdSuYq5aw-5yxLVAgFaSNAWR3XYNNw_t1zp_9KB-iWUwN7ncfKzHRkywlVves0qxlhjTu8ZuhwF1PFBPH2jINeF0Ohom1yvIzFnNftwrgkKQgSQHrV_tUem8NB-dXu4V0Ap_bNFGFKnh"
            }
        ...
        val spotifyClientToken: Flow<String> =
            settingsDataStore.data.map { preferences ->
                preferences[SPOTIFY_CLIENT_TOKEN] ?: "e6c2550759de4d9aa67e7750e3fb4dcc"
            }
